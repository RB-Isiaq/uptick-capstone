...
export const Hero = () => {
  return (
    <section className="relative flex bg-[#000] vector-bg mt-[-120px] pt-[120px]">
      <div className="w-full flex flex-col gap-[46px]  justify-center items-center px-3 xl:px-[60px] md:px-10 z-[2] py-[112px]">
