  ...
  return (
    <div className="bg-upLightBlue px-10 py-20 lg:px-32">
      <div className='flex flex-col gap-6 items-center justify-center text-center mb-[3rem]'>
        ...
        <p className='text-xl leading-[160%]'>Our core values are the driving force behind everything we do</p>
      </div>
        ...
        {VALUES.map((value, index) => (
          ...
          >
            ...
            <div className="flex flex-col gap-[0.94rem]">
              ...
              <p className="text-uptickGray text-xl leading-[160%]">{value.text}</p>
            </div>
          </div>
        ))}
      </div>
