      ...
      <AnimatePresenceDiv>
        {toggleMenu && (
          <MotionDiv
            ...
            className={`md:hidden flex-col items-start h[100vh]  px-6 w-full max-w-[280px] sm:max-w-[300px] left-0 bg-[inherit] backdrop-blur-2xl shadow-xl  fixed h-[100vh] z-[200] top-0 mt-[80px]
      `}
          >
