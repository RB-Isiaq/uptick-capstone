...
export const TestimonialCard = ({
  ...
  return (
    <div className="w-[330px] md:w-[730px] h-[500px] lg:h-[402px] p-4 md:p-[50px] bg-[#070C19] border border-[1px,solid,#1C3166] rounded-2xl flex flex-col gap-6 lg:justify-between flex-shrink-0">
