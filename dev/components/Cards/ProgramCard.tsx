...
export const ProgramCard = ({ image, title, desc, buttons }: Card) => {
  return (
    <div className="w-full md:w-[300px] lg:w-[450px] h-max lg:h-[623px] py-7 px-5 lg:p-[34px] flex flex-col  gap-6 justify-between items-start  border border-[#1C3166] rounded-2xl bg-[#1C1C1C] hover:shadow-lg ">
