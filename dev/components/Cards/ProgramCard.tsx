...
export const ProgramCard = ({ image, title, desc, buttons }: Card) => {
  return (
    <div className="w-full md:w-[550px] xl:w-[640px] h-max  2xl:h-[784px] flex flex-col  gap-6 items-start p-6 md:p-[50px] border border-[#1C3166] rounded-2xl bg-[#1C1C1C] hover:shadow-lg ">
